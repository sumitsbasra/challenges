...
- **Trophy rankings** — gold/silver/bronze for top 3 places on both leaderboard and home screen cards
- **Auto-join** — challenge creator is automatically added as participant #1
...
│   ├── Cache/           ChallengeCache, ParticipationCache (in-memory + disk)
...
│   ├── Detail/          Challenge detail, leaderboard, progress
│   ├── Home/            Home feed with today's activity + challenge cards
│   ├── Onboarding/      Sign in + HealthKit explanation screens
│   ├── Profile/         Health permissions, custom goals
│   └── Today/           Today view with activity rings
